					...
					<div class="row justify-content-md-center">
						<div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
							<div class="wt-innerbannercontent">
								<div class="wt-title"><h2>Hakkımızda</h2></div>
							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
								<div class="wt-articlesingle-holder wt-bgwhite">
									<div class="wt-articlesingle-content">
										...
										<div class="wt-title">
											<h2>TU-MANİ Apartmanı</h2>
										</div>
										<div class="wt-description">
											<h3>Genel Müdürümüzden Mesaj</h3>
											<h5>	TU-MANİ olarak, sahip olduğumuz değerlerle farklı faaliyet alanlarında İlerlemeye devam ediyoruz.
												Bu sitede yer alan çalışma da uzun yılların tecrübesi İle yürütmekte olduğumuz yazılım projelerinden yalnızca birini oluşturmakta ve bizler bu yazılımın sektörde önemli bir boşluğu dolduracağına İnanmaktayız.</h5>
										</div>
									</div>
								</div>
							</div>
