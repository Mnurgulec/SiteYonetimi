                                                                                                            ...
                                                                                                            <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                                                                                                                <div class="wt-dashboardtabs">
                                                                                                                    <ul class="wt-tabstitle nav navbar-nav">
                                                                                                                        <li class="nav-item">
                                                                                                                            <a class="active" data-toggle="tab" href="#wt-security">Ayarlar</a>
                                                                                                                        </li>
                                                                                                                    </ul>
                                                                                                                </div>
                                                                                                                <div class="wt-tabscontent tab-content">
                                                                                                                    <div class="wt-securityhold tab-pane active fade show" id="wt-security">
                                                                                                                        <div class="wt-securitysettings wt-tabsinfo">
                                                                                                                            ...
                                                                                                                            <form class="wt-formtheme wt-userform" action="AyarlarDegistir.jsp" method="post">

                                                                                                                                <fieldset>

                                                                                                                                    <div class="form-group form-disabeld">
                                                                                                                                        <input type="text" name="kullaniciTelefonNo" class="form-control" placeholder="Yeni telefon numaranızı giriniz.">
                                                                                                                                    </div>
                                                                                                                                    <div class="form-group form-disabeld">
                                                                                                                                        <input type="password" name="kullaniciSifresi" class="form-control" placeholder="Yeni şifrenizi giriniz.">
                                                                                                                                    </div>
                                                                                                                                </fieldset>
