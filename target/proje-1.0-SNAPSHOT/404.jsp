						...
						<div class="row justify-content-md-center">
							<div class="col-xs-12 col-sm-12 col-md-10 push-md-1 col-lg-8 push-lg-2">
								<div class="wt-404errorpage">
									<figure class="wt-404errorimg"><img src="images/404-img.jpg" alt="img description"></figure>
									<div class="wt-404errorcontent">
										<div class="wt-title">
											<h3>Hata!</h3>
										</div>
										<div class="wt-description">
											<p>Ana sayfaya gitmek için tıklayınız. <a href="Anasayfa.jsp">Ana Sayfa</a></p>
										</div>
