                                                                            ...
                                                                            <link rel="stylesheet" href="css/responsive.css">
                                                                                <link rel="stylesheet" href="css/dbresponsive.css">
                                                                                                                            ...
                                                                                                                            <ul>
                                                                                                                                <li >
                                                                                                                                    ...
                                                                                                                                    <ul class="sub-menu children">
                                                                                                                                        <li><a href="Giderlertakvimi-a.jsp">Giderler Takvimi</a></li>
                                                                                                                                    </ul>
                                                                                                                                </li>
                                                                                                                                <li>
                                                                                                        ...
                                                                                                        <nav id="wt-navdashboard" class="wt-navdashboard">
                                                                                                            <ul>
                                                                                                                <li class="menu-item-has-children">
                                                                                                                    ...
                                                                                                                    <ul class="sub-menu">
                                                                                                                        <li><hr><a href="Giderlertakvimi-a.jsp">Giderler Takvimi</a></li>
                                                                                                                    </ul>
                                                                                                                </li>
                                                                                                                <li>
                                                                                                                    <a href="Uyebilgileri-a.jsp">
                                                                                    ...
                                                                                    <%
                                                                                        ...
                                                                                        boolean b1=d1.daireNoAta(id, daireNo, katNo);
                                                                                        if(b1==true){
                                                                                         ...
                                                                                         out.println("<script>alert('Kullanıcıya daire atandanmadıı!.')</script>");
                                                                                         out.println("<script>window.location.href='Uyebilgileri-a.jsp';</script>");
                                                                                        }
