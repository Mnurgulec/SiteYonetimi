							...
							<div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
								<div class="wt-dashboardtabs">
									<ul class="wt-tabstitle nav navbar-nav">
										<li class="nav-item">
											<a class="active" data-toggle="tab" href="#wt-security">İsim-Soyisim</a>
										</li>
										<li class="nav-item"><a data-toggle="tab" href="#wt-password">Şifre</a></li>
										<li class="nav-item"><a data-toggle="tab" href="#wt-emailnoti">Email</a></li>
									</ul>
								</div>
											...
											<form class="wt-formtheme wt-userform">
												<fieldset>
													<div class="form-group form-group-half">
														<input type="text" name="eskiisim" class="form-control" placeholder="Eski isminizi giriniz.">
													</div>
													<div class="form-group form-group-half">
														<input type="text" name="yeniisim" class="form-control" placeholder="Yeni isminizi giriniz.">
													</div>
													<div class="form-group form-group-half">
														<input type="text" name="yenisoyad" class="form-control" placeholder="Eski soyadınızı giriniz.">
													</div>
													<div class="form-group form-group-half">
														<input type="text" name="yenisoyad" class="form-control" placeholder="Yeni soyadınızı giriniz.">
													</div>
												</fieldset>
												<fieldset>
													<div class="form-group form-group-half">
														<input type="text" name="eskitelno" class="form-control" placeholder="Eski telefon numaranızı giriniz.">
													</div>
													<div class="form-group form-group-half">
														<input type="text" name="yenitelno" class="form-control" placeholder="Yeni telefon numaranızı giriniz.">
													</div>
												</fieldset>
												<div class="wt-updatall">
													<i class="ti-announcement"></i>
													<span>Değişiklikleri kaydetmek için tıklayınız.</span>
													<a class="wt-btn" href="javascript:void(0);">Kaydet</a>
												</div>
											</form>
										</div>
									</div>
											...
											<form class="wt-formtheme wt-userform">
												<fieldset>
													<div class="form-group form-disabeld">
														<input type="password" name="eskisifre" class="form-control" placeholder="Eski şifrenizi giriniz." >
													</div>
													<div class="form-group form-disabeld">
														<input type="password" name="yenisifre" class="form-control" placeholder="Yeni şifrenizi giriniz.">
													</div>
												</fieldset>
												<div class="wt-updatall">
													<i class="ti-announcement"></i>
										...
										<div class="wt-emailnoti">
											...
											<div class="wt-settingscontent">
												<form class="wt-formtheme wt-userform">
													<fieldset>
														<div class="form-group form-group-half">
															<input type="password" name="eskiemail" class="form-control" placeholder="Eski emailinizi giriniz." >
														</div>
														<div class="form-group form-group-half">
															<input type="password" name="yeniemail" class="form-control" placeholder="Yeni emailinizi giriniz." >
														</div>
													</fieldset>
													<div class="wt-updatall">
														<i class="ti-announcement"></i>
