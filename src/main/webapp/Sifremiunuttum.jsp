							...
							<div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
								<div class="wt-dashboardtabs">
									<ul class="wt-tabstitle nav navbar-nav">
										<li class="nav-item">
											<a class="active" data-toggle="tab" href="#wt-security">Şifre</a>
										</li>
									</ul>
								</div>
								<div class="wt-tabscontent tab-content">
									<div class="wt-securityhold tab-pane active fade show" id="wt-security">
										<div class="wt-securitysettings wt-tabsinfo">
											...
											<form class="wt-formtheme wt-userform"action="SifreDegistir.jsp" method="post">
												<fieldset>
													...
													<div class="form-group form-group-half">
														<input type="text" name="yenisifre" class="form-control" placeholder="Yeni şifrenizi giriniz.">
													</div>
													</div>
												</fieldset>
												<div class="wt-updatall">
													<i class="ti-announcement"></i>
													<span>Şifrenizi değiştirmek için tıklayınız</span>
													<input type="submit" class="wt-btn" href="javascript:void(0);" value="Değiştir">
												</div>
											</form>
										</div>
									</div>
