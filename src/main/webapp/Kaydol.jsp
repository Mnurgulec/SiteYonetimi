											...
											<form class="wt-formtheme wt-userform">
												...
												<fieldset>
													<div class="form-group form-disabeld">
														<input type="text" name="telno" class="form-control" placeholder="Telefon numaranızı giriniz.">
													</div>
													...
													<div class="form-group form-disabeld">
														<input type="password" name="email" class="form-control" placeholder="Emailinizi giriniz." >
													</div>
												</fieldset>
